...
const UpdateJob = () => {
  const {id} = useParams();
  //console.log(id)
  const {__dirname,jobTitle,companyName,minPrice,maxPrice,salaryType,jobLocation,postingDate
  ...
  return (
    ...
    <div className="lg:w-1/2 w-full">
      ...
      <input type="url"  defaultValue={companyLogo} placeholder="Paste Your Logo URL: https://weshare.com/" 
