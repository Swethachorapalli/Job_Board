...
const Banner = ({query,handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
      ...
      <p className='text-lg text-black/70 mb-8'>We provide online instant cash loans with quick approval that suit your term length</p>
      <form>
        <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
          <div className='flex md:rounded-s-md rounded shadow-sm ring-1 ring-insert ring-gray-300
          ...
          <div className='flex md:rounded-s-none rounded shadow-sm ring-1 ring-insert ring-gray-300
