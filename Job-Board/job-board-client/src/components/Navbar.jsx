...
const Navbar = () => {
  ...
  return (
    <header className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
      <nav className="flex justify-between items-cneter py-6">
        <a href="/"  className="flex items-center gap-2 text-2xl text-black">
          ...
          <circle
            ...
            fillOpacity="0.4"
            />
            <circle cx="16.9859" cy="17.4857" r="12.0143" fill="#3575E2" />
        </svg>
        <span> JobBoard</span>
       </a>
       ...
       <ul className="hidden md:flex gap-12">
        ...
        <div className="text-base text-primary font-media space-x-5 hidden lg:block">
